...
PROCÉDURE :
- Désignation notifiée à l'ARTCI
- L'ARTCI dispose de 30 jours pour s'opposer
...
- 1ère infraction : jusqu'à 10 000 000 FCFA
- Récidive dans les 5 ans : jusqu'à 100 000 000 FCFA OU 5% du chiffre d'affaires annuel
...
- Données RH salariés : 5 ans après départ
...
MODE VALIDATION (champ par champ) :
Réponds UNIQUEMENT en JSON : {"type":"ok|warn|err|info","message":"message court"}
Maximum 2 phrases. Exemples concrets CI.
