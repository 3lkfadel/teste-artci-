...
const FORMULAIRES = [
  {
    ...
    desc:     'Pour tout traitement courant de données personnelles : clients, RH, marketing...',
    badge:    'Simple déclaration',
    sensible: false,
  },
  {
    type:     'autorisation',
    titre:    "Demande d'autorisation préalable",
    desc:     'Pour les données sensibles : biométrie, santé, NNI, vidéosurveillance.',
  ...
  },
  {
    ...
    desc:     'Désigner officiellement votre Délégué à la Protection des Données.',
    badge:    'Correspondant DPO',
    sensible: false,
  },
  {
    type:     'transfert',
    titre:    'Transfert international de données',
    desc:     "Pour tout envoi de données personnelles hors de Côte d'Ivoire.",
    ...
    <>
      <nav className="nav">
        ...
        <div className="nav-right">
          ...
          <span className="nav-link" onClick={() => { localStorage.removeItem('token'); nav('/auth') }}>
            Déconnexion
          </span>
        </div>
      </nav>
